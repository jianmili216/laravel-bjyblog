            ...
            @foreach($comments as $comment)
                <div id="comment-{{ $comment->id }}" class="row b-user b-parent">
                    ...
                    <div class="col-xs-10 col-sm-11 col-md-11 col-lg-11 b-content-col b-cc-first">
                        ...
                        <p class="b-date">
                            {{ $comment->created_at }} <a class="js-reply" href="javascript:;" aid="{{ $article->id }}" pid="{{ $comment->id }}" username="{{ $comment->socialiteUser->name }}">{{ __('Reply') }}</a>
                        </p>
                        @foreach($comment->children as $reply)
                            <div id="comment-{{ $reply->id }}" class="row b-user b-child">
                                ...
                                <ul class="col-xs-10 col-sm-11 col-md-11 col-lg-11 b-content-col">
                                    ...
                                    <li class="b-date">
                                        {{ $reply->created_at }} <a class="js-reply" href="javascript:;" aid="{{ $article->id }}" pid="{{ $reply->id }}" username="{{ $reply->parentComment->socialiteUser->name }}">{{ __('Reply') }}</a>
                                    </li>
                                    <li class="b-clear-float"></li>
                                </ul>
                            </div>
